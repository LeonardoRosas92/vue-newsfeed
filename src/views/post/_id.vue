...
<template>
    <main class="post-page">
        <section v-if="post" class="container mx-auto p-4">
            <img :src="CreateURL(post.image, 1280, 300)" alt="Banner" class="w-full mb-8">
            ...
            <div class="flex items-center mb-4">
                <img :src="CreateURL(post.author.avatar, 300,300)" alt="Author" class="inline-block rounded-full w-12 h-12 mr-4">
